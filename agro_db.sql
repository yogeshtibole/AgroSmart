...
--    psql <connection_url> -f agro_db.sql
--
--  OR just deploy — ensure_tables() in app.py auto-creates
...
CREATE TABLE IF NOT EXISTS farmers (
    ...
    phone       TEXT UNIQUE NOT NULL,       -- login key
    farm_size   FLOAT,
    soil_ph     FLOAT,
...
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'farmers_phone_unique'
    ) THEN
